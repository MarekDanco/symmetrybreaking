c [SCRIPT] Command line: /home/mikolas/mc/group/2.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/group/2.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 30
c [INITIAL INPUT] Number of clauses: 95
c [INITIAL INPUT] Number of binary clauses: 26
c [INITIAL INPUT] Number of ternary clauses: 68
c [INITIAL INPUT] Number of clauses larger than 3: 0
c [INITIAL INPUT] Number of literals: 257
c
...
c [BACKBONE] Time to compute the backbone: 0.000557
c [BACKBONE] Number of SAT calls: 1
c [BACKBONE] Backbone size: 30
...
c [REDUCER PROPAGATOR] Memory needed: 3424
c [REDUCER PROPAGATOR] Binary clauses: 26
c [REDUCER PROPAGATOR] Not binary clauses: 68
c [REDUCER PROPAGATOR] Number of literals in not binary clauses: 204
...
c [ELIMINATOR] #elim-gate = 8	#elim-resolution = 22
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 496
...
c [PREPROCESSED INPUT] Number of variables: 30
c [PREPROCESSED INPUT] Number of clauses: 30
...
c [PREPROCESSED INPUT] Number of literals: 30
c
c

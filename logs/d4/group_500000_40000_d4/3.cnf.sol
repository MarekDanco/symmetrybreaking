c [SCRIPT] Command line: /home/mikolas/mc/group/3.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/group/3.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 120
c [INITIAL INPUT] Number of clauses: 584
c [INITIAL INPUT] Number of binary clauses: 66
c [INITIAL INPUT] Number of ternary clauses: 517
c [INITIAL INPUT] Number of clauses larger than 3: 0
c [INITIAL INPUT] Number of literals: 1684
c
...
c [BACKBONE] Time to compute the backbone: 0.001062
c [BACKBONE] Number of SAT calls: 1
c [BACKBONE] Backbone size: 120
...
c [REDUCER PROPAGATOR] Memory needed: 23144
c [REDUCER PROPAGATOR] Binary clauses: 66
c [REDUCER PROPAGATOR] Not binary clauses: 517
c [REDUCER PROPAGATOR] Number of literals in not binary clauses: 1551
...
c [ELIMINATOR] #elim-gate = 27	#elim-resolution = 93
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 1936
...
c [PREPROCESSED INPUT] Number of variables: 120
c [PREPROCESSED INPUT] Number of clauses: 120
...
c [PREPROCESSED INPUT] Number of literals: 120
c
c

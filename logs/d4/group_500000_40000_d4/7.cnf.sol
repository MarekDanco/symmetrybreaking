c [SCRIPT] Command line: /home/mikolas/mc/group/7.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/group/7.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 122542
c [INITIAL INPUT] Number of clauses: 78366
c [INITIAL INPUT] Number of binary clauses: 2512
c [INITIAL INPUT] Number of ternary clauses: 73988
c [INITIAL INPUT] Number of clauses larger than 3: 1865
c [INITIAL INPUT] Number of literals: 238213
c
...
c [BACKBONE] Time to compute the backbone: 0.05605
c [BACKBONE] Number of SAT calls: 11
c [BACKBONE] Backbone size: 3602
c [BACKBONE] Number of units detected by calling the solver: 10
c [CONSTRUCTOR] Solver: Glucose
...
c [BIPARTITION] #Gates: 343
c [BIPARTITION] #Model considered for preproc with models: 0
c [BIPARTITION] #Input variables from models as preproc: 0
c [BIPARTITION] Initial input set: 0
c [CONSTRUCTOR] Solver: Glucose
...
c [BIPARTITION] #Input variables computed: 0
c [BIPARTITION] #Input variables that are undertermined: 0
c [BIPARTITION] Time needed to compute the partition: 0.043995
...
c [REDUCER PROPAGATOR] Memory needed: 5082452
c [REDUCER PROPAGATOR] Binary clauses: 2512
c [REDUCER PROPAGATOR] Not binary clauses: 75853
c [REDUCER PROPAGATOR] Number of literals in not binary clauses: 233188
...
c [REDUCER OCC-ELIMINATION] #literal removed: 2622
c [REDUCER OCC-ELIMINATION] Number of literals removed: 2622
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 29880
c [REDUCER VIVIFICATION] Number of clauses removed: 14942
c [REDUCER Combinaison] #Iteration: 1
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 5347
c [REDUCER OCC-ELIMINATION] Number of literals removed: 5347
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 45845
c [REDUCER VIVIFICATION] Number of clauses removed: 22846
c [REDUCER Combinaison] #Iteration: 2
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 7028
c [REDUCER OCC-ELIMINATION] Number of literals removed: 7028
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 53652
c [REDUCER VIVIFICATION] Number of clauses removed: 26734
c [REDUCER Combinaison] #Iteration: 3
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 8064
c [REDUCER OCC-ELIMINATION] Number of literals removed: 8064
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 57317
c [REDUCER VIVIFICATION] Number of clauses removed: 28546
c [REDUCER Combinaison] #Iteration: 4
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 8840
c [REDUCER OCC-ELIMINATION] Number of literals removed: 8840
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 58617
c [REDUCER VIVIFICATION] Number of clauses removed: 29199
c [ELIMINATOR] #elim-gate = 4875	#elim-resolution = 119553
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 1960688
...
c [PREPROCESSED INPUT] Number of variables: 122542
c [PREPROCESSED INPUT] Number of clauses: 124428
...
c [PREPROCESSED INPUT] Number of literals: 124428
c
c

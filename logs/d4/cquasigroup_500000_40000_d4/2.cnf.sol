c [SCRIPT] Command line: /home/mikolas/mc/cquasigroup/2.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/cquasigroup/2.cnf cnf
...
c [INITIAL INPUT] Number of clauses: 72
c [INITIAL INPUT] Number of binary clauses: 40
c [INITIAL INPUT] Number of ternary clauses: 32
c [INITIAL INPUT] Number of clauses larger than 3: 0
c [INITIAL INPUT] Number of literals: 176
c
...
c [BACKBONE] Time to compute the backbone: 0.000911
...
c [BIPARTITION] Time needed to compute the partition: 0
...
c [REDUCER PROPAGATOR] Memory needed: 3184
c [REDUCER PROPAGATOR] Binary clauses: 40
...
c [REDUCER OCC-ELIMINATION] #literal removed: 1
c [REDUCER OCC-ELIMINATION] Number of literals removed: 1
...
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 3
c [REDUCER VIVIFICATION] Number of clauses removed: 3
...
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 4
c [REDUCER VIVIFICATION] Number of clauses removed: 3
...
c [REDUCER VIVIFICATION] Number of literals removed: 4
c [REDUCER VIVIFICATION] Number of clauses removed: 3
c [ELIMINATOR] #elim-gate = 8	#elim-resolution = 90
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 1584
...
c [PREPROCESSED INPUT] Number of clauses: 98
...
c [PREPROCESSED INPUT] Number of literals: 98
c
c

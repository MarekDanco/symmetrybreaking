c [SCRIPT] Command line: /home/mikolas/mc/loop/2.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/loop/2.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 10
c [INITIAL INPUT] Number of clauses: 35
c [INITIAL INPUT] Number of binary clauses: 34
c [INITIAL INPUT] Number of ternary clauses: 0
c [INITIAL INPUT] Number of clauses larger than 3: 0
c [INITIAL INPUT] Number of literals: 69
c
...
c [BACKBONE] Time to compute the backbone: 0.000703
...
c [REDUCER PROPAGATOR] Memory needed: 448
c [REDUCER PROPAGATOR] Binary clauses: 34
...
c [ELIMINATOR] #elim-gate = 8	#elim-resolution = 2
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 176
...
c [PREPROCESSED INPUT] Number of variables: 10
c [PREPROCESSED INPUT] Number of clauses: 10
...
c [PREPROCESSED INPUT] Number of literals: 10
c
c

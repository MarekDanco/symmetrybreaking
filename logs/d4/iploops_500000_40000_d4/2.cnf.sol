c [SCRIPT] Command line: /home/mikolas/mc/iploops/2.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/iploops/2.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 14
c [INITIAL INPUT] Number of clauses: 63
c [INITIAL INPUT] Number of binary clauses: 38
c [INITIAL INPUT] Number of ternary clauses: 24
c [INITIAL INPUT] Number of clauses larger than 3: 0
c [INITIAL INPUT] Number of literals: 149
c
...
c [BACKBONE] Time to compute the backbone: 0.000181
...
c [REDUCER PROPAGATOR] Memory needed: 1504
c [REDUCER PROPAGATOR] Binary clauses: 38
c [REDUCER PROPAGATOR] Not binary clauses: 24
c [REDUCER PROPAGATOR] Number of literals in not binary clauses: 72
...
c [ELIMINATOR] #elim-gate = 8	#elim-resolution = 6
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 240
...
c [PREPROCESSED INPUT] Number of variables: 14
c [PREPROCESSED INPUT] Number of clauses: 14
...
c [PREPROCESSED INPUT] Number of literals: 14
c
c

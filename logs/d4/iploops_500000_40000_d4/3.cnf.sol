c [SCRIPT] Command line: /home/mikolas/mc/iploops/3.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/iploops/3.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 39
c [INITIAL INPUT] Number of clauses: 323
c [INITIAL INPUT] Number of binary clauses: 165
c [INITIAL INPUT] Number of ternary clauses: 157
c [INITIAL INPUT] Number of clauses larger than 3: 0
c [INITIAL INPUT] Number of literals: 802
c
...
c [BACKBONE] Time to compute the backbone: 0.000289
c [BACKBONE] Number of SAT calls: 1
c [BACKBONE] Backbone size: 39
...
c [REDUCER PROPAGATOR] Memory needed: 8240
c [REDUCER PROPAGATOR] Binary clauses: 165
c [REDUCER PROPAGATOR] Not binary clauses: 157
c [REDUCER PROPAGATOR] Number of literals in not binary clauses: 471
...
c [ELIMINATOR] #elim-gate = 27	#elim-resolution = 12
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 640
...
c [PREPROCESSED INPUT] Number of variables: 39
c [PREPROCESSED INPUT] Number of clauses: 39
...
c [PREPROCESSED INPUT] Number of literals: 39
c
c

c [SCRIPT] Command line: /home/mikolas/mc/iploops/4.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/iploops/4.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 4337
c [INITIAL INPUT] Number of clauses: 1662
c [INITIAL INPUT] Number of binary clauses: 591
c [INITIAL INPUT] Number of ternary clauses: 1019
c [INITIAL INPUT] Number of clauses larger than 3: 51
c [INITIAL INPUT] Number of literals: 4459
c
...
c [BACKBONE] Time to compute the backbone: 0.00317
c [BACKBONE] Number of SAT calls: 3
c [BACKBONE] Backbone size: 93
...
c [BIPARTITION] Time needed to compute the partition: 0.002929
...
c [REDUCER PROPAGATOR] Memory needed: 117728
c [REDUCER PROPAGATOR] Binary clauses: 591
c [REDUCER PROPAGATOR] Not binary clauses: 1070
c [REDUCER PROPAGATOR] Number of literals in not binary clauses: 3276
...
c [REDUCER OCC-ELIMINATION] #literal removed: 174
c [REDUCER OCC-ELIMINATION] Number of literals removed: 174
...
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 186
c [REDUCER OCC-ELIMINATION] Number of literals removed: 186
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
...
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 188
c [REDUCER OCC-ELIMINATION] Number of literals removed: 188
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
...
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 190
c [REDUCER OCC-ELIMINATION] Number of literals removed: 190
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 184
c [REDUCER VIVIFICATION] Number of clauses removed: 92
c [ELIMINATOR] #elim-gate = 63	#elim-resolution = 4269
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 70176
...
c [PREPROCESSED INPUT] Number of variables: 4337
c [PREPROCESSED INPUT] Number of clauses: 4428
...
c [PREPROCESSED INPUT] Number of literals: 4524
c
c

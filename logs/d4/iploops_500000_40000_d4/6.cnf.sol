c [SCRIPT] Command line: /home/mikolas/mc/iploops/6.cnf
c [SCRIPT] Options: 
c [CONSTRUCTOR] Problem: /home/mikolas/mc/iploops/6.cnf cnf
c [PASER]  Model Counting problem
c [INITIAL INPUT] [4m[32mStatistics about the input formula[0m
c [INITIAL INPUT] Number of variables: 48020
c [INITIAL INPUT] Number of clauses: 22989
c [INITIAL INPUT] Number of binary clauses: 3513
c [INITIAL INPUT] Number of ternary clauses: 18694
c [INITIAL INPUT] Number of clauses larger than 3: 781
c [INITIAL INPUT] Number of literals: 67403
c
...
c [BACKBONE] Time to compute the backbone: 0.023807
c [BACKBONE] Number of SAT calls: 28
c [BACKBONE] Backbone size: 461
c [BACKBONE] Number of units detected by calling the solver: 26
c [CONSTRUCTOR] Solver: Glucose
c [DAC] #Equivalence classes: 1
c [DAC] #Equivalences: 35
c [DAC] #And gates: 0
c [DAC] #XOR gates: 0
c [BIPARTITION] #Projected: 216
c [BIPARTITION] #Protected: 0
c [BIPARTITION] #Gates: 215
...
c [BIPARTITION] Time needed to compute the partition: 0.025799
...
c [REDUCER PROPAGATOR] Memory needed: 1598852
c [REDUCER PROPAGATOR] Binary clauses: 3513
c [REDUCER PROPAGATOR] Not binary clauses: 19475
c [REDUCER PROPAGATOR] Number of literals in not binary clauses: 60376
...
c [REDUCER OCC-ELIMINATION] #literal removed: 6590
c [REDUCER OCC-ELIMINATION] Number of literals removed: 6590
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 2434
c [REDUCER VIVIFICATION] Number of clauses removed: 1679
c [REDUCER Combinaison] #Iteration: 1
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 7754
c [REDUCER OCC-ELIMINATION] Number of literals removed: 7754
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 3553
c [REDUCER VIVIFICATION] Number of clauses removed: 2477
c [REDUCER Combinaison] #Iteration: 2
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 8341
c [REDUCER OCC-ELIMINATION] Number of literals removed: 8341
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 4102
c [REDUCER VIVIFICATION] Number of clauses removed: 2855
c [REDUCER Combinaison] #Iteration: 3
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 8617
c [REDUCER OCC-ELIMINATION] Number of literals removed: 8617
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 4365
c [REDUCER VIVIFICATION] Number of clauses removed: 3045
c [REDUCER Combinaison] #Iteration: 4
c [REDUCER OCC-ELIMINATION] Number of iterations: 1
c [REDUCER OCC-ELIMINATION] Verbose: 1
c [REDUCER OCC-ELIMINATION] #Iteration: 0
c [REDUCER OCC-ELIMINATION] #literal removed: 8742
c [REDUCER OCC-ELIMINATION] Number of literals removed: 8742
c [REDUCER VIVIFICATION] Number of iterations: 1
c [REDUCER VIVIFICATION] Verbose: 1
c [REDUCER VIVIFICATION] #Iteration: 0
c [REDUCER VIVIFICATION] Number of literals removed: 4502
c [REDUCER VIVIFICATION] Number of clauses removed: 3145
c [ELIMINATOR] #elim-gate = 215	#elim-resolution = 47804
c [REDUCER PROPAGATOR] Construtor
c [REDUCER PROPAGATOR] Memory needed: 768336
...
c [PREPROCESSED INPUT] Number of variables: 48020
c [PREPROCESSED INPUT] Number of clauses: 48019
...
c [PREPROCESSED INPUT] Number of literals: 48019
c
c
